...
<%@page import="com.agencyport.connector.MessageMapStore"%>
<%@page import="com.agencyport.product.ProductDefinitionsManager"%>
<div id="initialDisplayMessages" >
<%    
...
if ( msgsAvailable ){
	...
	if (errors.size() > 0 ) {
	    ...
	    %>
	    <div id="alert_<%=cssStyleClass%>" class="<%=cssStyleClass%>">
	...
	// NOTE the following ELSE keyword is commented out so we can always see ALL messages, regardless of type
	/* else */ {  
...
<script type="text/javascript" src="<%= jspHelper.getWebContentPrefix() %>javascript/ap_messaging.js?<%=versionNumber%>"></script>
