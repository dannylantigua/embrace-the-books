...
<div class="navbar navbar-default navbar-fixed-top main-menu" id="main-menu" role="navigation">
	<div class="container">
		...
		<div class="navbar-header">
			...
			<span class="navbar-brand"><%= coreRB.getString("menu.Name.Agencyportal") %></span>
		</div>
		<div class="collapse navbar-collapse">
			<% if (securityProfile != null) {%> 				
				<ul class="nav navbar-nav navbar-right current-user">
					<li class="dropdown">
						<a id="menu-entry-current-user" data-toggle="dropdown" class="dropdown-toggle" href="#"><%= securityProfile.getSubject().getUserInfo().getFullName() %> <b class="caret"></b></a>
				...
				<ul class="nav navbar-nav navbar-right get-started">
					<li class="dropdown">
						<a id="menu-entry-get-started" data-toggle="dropdown" class="dropdown-toggle" href="#"><span><%=coreRB.getString("menu.get.started")%></span><b class="caret"></b></a>
						<ul class="dropdown-menu">
