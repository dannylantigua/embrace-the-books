...
$(document).ready(function() {
	...
	new ap.ModalAccountSearchManager('move-workitem-search-input', 'move-workitem-search-button', 'move-workitem-search-results-listing', ap.MoveManager.selectAccount, false );
	var accountSearchmanager =  new ap.ModalAccountSearchManager('move-account-search-input', 'move-account-search-button', 'move-account-search-results-listing', ap.MoveManager.selectAccount, false );
	   ...
	   showMove : function() {
		...
		selectAccount :  function ( element, event  ) {
		    ...
		    function(response, textStatus, jqXHR) {
		    	...
		    	response = $.trim(response);
		    	var data = $.parseJSON(response);		
		    	$('#move-account-success #move-account-success-message').html(ap.htmlDecode(data.response.message));
