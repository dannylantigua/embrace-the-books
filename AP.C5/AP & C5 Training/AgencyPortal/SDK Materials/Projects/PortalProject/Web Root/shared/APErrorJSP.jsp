...
<section id="error_page">
	...
	<div class="container white-background">
		<div class="row">
			<div class="col-xs-12">
				<div class="jumbotron white-background center">
					<h1><%=coreRB.getString("header.ProblemWithRequest")%></h1>
					<br />
					<p><%=highLevelMessage%></p>
					<a href="DisplayHomePage" class="btn btn-large btn-primary"><%=coreRB.getString("action.ClickHereToContinue")%></a>
				</div>
				<% if ( showExtendedErrorDetail ) { %>
					<p>
					<div>
						<p class="center"><a href="javascript: ap.toggleExtendedErrorInfo();void(0);"><%=coreRB.getString("action.ToggleExtendedError")%></a></p>
					</div>	
